...
const Four = () => {
    ...
    return (
        ...
        <h1 className='font-bold text-2xl sm:text-2xl md:text-3xl lg:text-3xl xl:text-3xl my-10 p-2 text-blue-700 tracking-[2px]' >{t('Our special car rental offers')}</h1>
...
<div className="flex flex-col">
   <div className='flex pt-2'>
        ...
        <button className="m-auto border-2 border-blue-800 text-xl text-blue-700 rounded-lg px-6 hover:bg-blue-800 hover:text-white">
          <Link to="/offers">{t('Show All Cars')}</Link>
        </button>
      </div>
