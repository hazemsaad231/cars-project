...
const Brand = () => {
  return (
    <div data-aos="fade-up" className="my-20">
      <h1 className="font-bold text-2xl sm:text-2xl md:text-3xl lg:text-3xl xl:text-3xl mb-16 mt-8 text-blue-700 tracking-[5px]" style={{ fontFamily: "arial" }}>
        Popular Brands
      </h1>
...
const BrandItem = memo(({ Icon }) => (
  <div className="border border-gray-300 rounded-lg p-4 bg-transparent" id="btn">
    <Icon
      className="text-blue-700 m-auto text-8xl transition-transform duration-300 hover:scale-110"
